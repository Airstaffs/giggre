	...
	<div class="cas--settings__content">
		<div class="cas--settings__layout-row">
			...
			<div class="cas--settings__layout-row-item">
				...
				?>
				<div>
					<?php wp_nonce_field( 'canvas_save_theme_nonce', 'security' ); ?>
		...
		<div class="cas--settings__layout-row">
			<div class="cas--settings__layout-row-item">
				...
				<p class="cas--description"><?php esc_html_e( 'Determines how the plugin will identify that the user is in the app', 'canvas' ); ?></p>
			</div>
