...
class Canvas {
	...
	static function activate() {
		...
		self::add_user_role();
		if (!self::get_option('app_builder_experience')) {
			self::set_option('app_builder_experience', 'no'); // insert default value on plugin activate
		}
	}
	...
	static function uninstall() {
		// delete push notification tags
		self::delete_option('push_notification_tags');
	}

	/**
	 * delete app builder data from wordpress
	 */
	public static function delete_app_builder_records() {
		self::delete_option('app_builder_experience');
		self::delete_option('app_builder_experience_privacy_agreement');
	}
	...
	*/
	...
	public static function delete_option($name) {
		return delete_option( 'canvas-' . $name);
	}
}
